        ...
        <header class="bg-white">
            <div class="container mx-auto px-6 py-3">
                ...
                <nav class="flex flex-wrap justify-center mt-2 space-x-4 text-gray-600">
                    ...
                    <a href="/tables" class="text-sm hover:underline">Meus Eventos</a>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4">
        @foreach($events as $event)
            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 ease-in-out p-4 overflow-hidden">
                ...
                <div class="px-1 py-2">
                    <div class="text-gray-700 text-base mb-4 truncate">{{ date('d/m/Y', strtotime($event->date)) }}</div>
                ...
                <div class="px-1 py-2">
                    <a href="/exibir_evento/{{ $event->id }}">Saiba mais</a>
                </div>
            </div>
        @endforeach
