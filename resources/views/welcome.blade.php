...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    @endforeach
        ...
        @if(count($events) == 0 && $search)
            <p class="text-center text-lg">Não foi possível encontrar nenhum evento com: <span class="font-semibold">{{ $search }}</span>! <a class="text-blue-500 hover:underline" href="/">Ver todos.</a></p>
        @elseif(count($events) == 0)
            <p class="text-center text-lg">Não há eventos disponíveis no momento.</p>
        @endif
    </div>
</div>
    ...
    <div class="flex justify-center">
        <div class="flex rounded-md mt-8">
            ...
            <a href="#" class="py-2 px-4 leading-tight bg-white border border-gray-200 text-blue-700 rounded-r hover:bg-blue-500 hover:text-white"><span>Next</span></a>
                    ...
                    <footer class="py-16 text-center text-sm text-black text/70">
